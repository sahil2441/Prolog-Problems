...
puzzle(1,P) :- 
   P = [_,_,4,_,_,_,_,1,7, 6,7,_,9,_,_,_,_,_, 5,_,8,_,3,_,_,_,4,
        3,_,_,7,4,_,1,_,_, _,6,9,_,_,_,7,8,_, _,_,1,_,6,_,_,_,5,
	1,_,_,_,8,_,_,_,6, _,_,_,_,_,6,_,9,1, 2,4,_,_,_,1,5,_,_].
